...
MODEL_OPTIONS = ["sora-2-text-to-video", "sora-2-text-to-video-stable"]
PROMPT_MAX_LENGTH = 10000
ASPECT_RATIO_OPTIONS = ["landscape", "portrait"]
DURATION_OPTIONS = ["10", "15"]


def run_sora2_t2v_video(
    prompt: str,
    model: str,
    aspect_ratio: str,
    n_frames: str,
    ...
    _log(log, f"Creating Sora 2 T2V task (model={model})...")
